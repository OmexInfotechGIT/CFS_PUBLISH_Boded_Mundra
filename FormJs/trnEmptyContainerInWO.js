$(document).ready(function () {
    Autocompletebox("Exporter", "ExporterID", "trnEmptyContainerInWO", "GetEXP");
    Autocompletebox("ConsolerName", "ConsolerID", "trnEmptyContainerInWO", "GetConsoler");
    Autocompletebox("CHAName", "CHAID", "trnEmptyContainerInWO", "GetCHA");
    Autocompletebox("ForwarderName", "ForwarderID", "trnEmptyContainerInWO", "GetForwarder");
    Autocompletebox("FromLocation", "FromLocationID", "trnEmptyContainerInWO", "GetFromLocation");    
    Autocompletebox("Agent", "AgentID", "trnEmptyContainerInWO", "GetAgent", "CallbackautocompleteForLine");
    Autocompletebox("ISOCode", "ISOCodeID", "trnEmptyContainerInWO", "GetISOCODE", "FillISOCodeDetails");
    ...
    if (doaction.toLowerCase() == "add") {
        document.getElementById("LiftOnBy").selectedIndex = 1;
        document.getElementById("LiftOffBy").selectedIndex = 0;
        //document.getElementById("LiftOffBy").selectedIndex = 0;
    }
...
function FillISOCodeDetails() {
    if ($("#ISOCodeID").val() != "" && $("#ISOCode").val() != undefined && $("#ISOCodeID").val() != null) {
        $.ajax({
            url: GetRootPath + "trnEmptyContainerInWO/GetISOCodeSizeAndType/" + $("#ISOCodeID").val(),
            type: "GET",
            dataType: "text",
...
function CallbackautocompleteForLine() {
    Autocompletebox("Line", "LineID", "trnEmptyContainerInWO", "GetLine/" + $("#AgentID").val());
}
...
function validate() {
    ...
    $.ajax({
        url: GetRootPath + "trnEmptyContainerInWO/validateModel",
        type: "Post",
        data: $("form").serialize(),
        dataType: "text",
        async: false,
...
function ValidateContainerDetails(tab) {
    ...
    $.ajax({
        url: GetRootPath + "trnEmptyContainerInWO/validateContainerModel",
        type: "Post",
        data: $("form").serialize(),
        dataType: "text",
        async: false,
    ...
    if (isvalid) {
        $.ajax({
            url: GetRootPath + "trnEmptyContainerInWO/AddContainerDetails",
            type: "Post",
            data: $("form").serialize(),
            dataType: "text",
            async: false,
...
function FillContainerDetailsGrid() {
    ...
    $.ajax({
        url: GetRootPath + "trnEmptyContainerInWO/FillContainerDetailsGrid",
        type: "Post",
        data: $("form").serialize(),
        dataType: "text",
        success: function (data) {
...
function DeleteContainerDetails() {
    ...
    var ID = $("#DeletetrnEmptyContainerInWOContainerDetailsID").val();
    ...
    if (IsValid && ID != null && ID != "" && ID != undefined && ID != "0") {
        ...
        $.ajax({
            url: GetRootPath + "trnEmptyContainerInWO/DeleteContainerDetails/" + ID + "?DeleteRemarks=" + DeleteRemarks,
            type: "Post",
            data: $("form").serialize(),
            dataType: "text",
            async: false,
...
function DeleteContainerDetailsByID(ID) {
    $("#DeletetrnEmptyContainerInWOContainerDetailsID").val(ID);
}