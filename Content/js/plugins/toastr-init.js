...
function TosterAlert(MessageType, Message, MessageTitle = AlertMessageTitle.NONE,  positioncls = AlertPosition.Top_Right)
{
    MessageTitle = MessageTitle.charAt(0).toUpperCase() + MessageTitle.slice(1);
    ...
    {
        toastr.info(Message, MessageTitle, {
            timeOut: 3000,
            closeButton: !0,
            debug: !1,
            newestOnTop: !0,
