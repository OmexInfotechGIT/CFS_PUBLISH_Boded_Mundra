...
CREATE TABLE [dbo].[trnEmptyContainerOutWO](
	[trnEmptyContainerOutWOID] [bigint] IDENTITY(1,1) NOT NULL,
...
ALTER TABLE [dbo].[trnEmptyContainerOutWO] ADD  DEFAULT ((0)) FOR [IsEmptyGateOutprocess]
GO

ALTER TABLE [dbo].[trnEmptyContainerOutWO] ADD  DEFAULT ((0)) FOR [Flagdeleted]
GO

ALTER TABLE [dbo].[trnEmptyContainerOutWO] ADD  DEFAULT ([dbo].[GetCurrentDateTime]()) FOR [CreatedDate]
GO

ALTER TABLE [dbo].[trnEmptyContainerOutWO] ADD  DEFAULT ('REGULAR') FOR [ContainerStatus]
GO
