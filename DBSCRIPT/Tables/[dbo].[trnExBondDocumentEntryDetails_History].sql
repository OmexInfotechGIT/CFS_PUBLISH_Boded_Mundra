...
/****** Object:  Table [dbo].[trnExBondDocumentEntryDetails]    Script Date: 01/05/2024 3:46:57 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[trnExBondDocumentEntryDetails_History](
	[trnExBondDocumentEntryDetails_HistoryID] [bigint] IDENTITY(1,1) NOT NULL,
	[trnExBondDocumentEntryDetailsID] [bigint] NOT NULL,
...
ALTER TABLE [dbo].[trnExBondDocumentEntryDetails_History] ADD  DEFAULT ((0)) FOR [Flagdeleted]
GO

ALTER TABLE [dbo].[trnExBondDocumentEntryDetails_History] ADD  DEFAULT ([dbo].[GetCurrentDateTime]()) FOR [CreatedDate]
GO
